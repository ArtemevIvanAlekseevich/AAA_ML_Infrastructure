...
index_letter_map = {0: '9', 1: 'н', 2: 'а', 3: 'к', 4: 'м', 5: '5', 6: 'е', 7: '3', 8: 'т', 9: 'х', 10: 'о',
                    11: '8', 12: '0', 13: 'у', 14: '4', 15: 'р', 16: '7', 17: '2', 18: '1', 19: 'с', 20: 'в', 21: '6'}
...
class PlateReader(nn.Module):
    def __init__(self, ):
        ...
        self.cnn = nn.Conv1d(in_channels=512, kernel_size=3,
                             padding=1, out_channels=N_LETTERS)
        self.relu = nn.ReLU()
    ...
    def read_text(self, image: bytes) -> str:
        ...
        with torch.no_grad():
            ...
            res = ''.join([index_letter_map[j]
                           for j in y_pred.cpu()[0].numpy()])
